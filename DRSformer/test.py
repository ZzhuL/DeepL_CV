...
parser.add_argument('--task', default='Deraining', required=False, type=str, help='Task to run', choices=['Deraining'])
...
weights = "C:\\Users\\zhu0l\\Desktop\\bishe\\code\\DRSformer-main\\pretrained_models\\deraining_Rain200H.pth"
weights = './pretrained_models/deraining_DDN-Data.pth'
print(weights)
